...
public class ICertificate extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtSalaryInRupees = new javax.swing.JTextField();
        jLabel21 = new javax.swing.JLabel();

        setTitle("Income Certificate");
        setOpaque(false);
        ...
        lblPageNo.setBounds(6, 0, 171, 17);

        lblCPSNo.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblCPSNo.setText("CPS NO:IC-0001");
        getContentPane().add(lblCPSNo);
        lblCPSNo.setBounds(543, 0, 130, 17);
        ...
        jPanel1.setBounds(6, 23, 666, 281);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cmbRecommended, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cmbDistrict, 0, 123, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        jPanel2.setBounds(6, 310, 666, 120);
        ...
        btnSave.setBounds(188, 530, 55, 29);
        ...
        btnClear.setBounds(431, 530, 58, 29);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Income Certificate Information", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14))); // NOI18N
        ...
        jLabel2.setText("Per Year Salary In Rupees:");

        txtSalaryInRupees.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtSalaryInRupees, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addComponent(jLabel1)
                .addComponent(txtSalaryInRupees, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addComponent(jLabel2))
        );

        getContentPane().add(jPanel3);
        jPanel3.setBounds(6, 436, 666, 88);

        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/screenshot-pxhere.com-2017-11-04-23-13-09-801.png"))); // NOI18N
        getContentPane().add(jLabel21);
        jLabel21.setBounds(-12, 0, 700, 570);
    ...
    private void getcpCertificateNo() {
        IncomeCBal incomeCBal = new IncomeCBal();
        CDetailBean cpsCertificateNO = incomeCBal.getCPSCertificateNO();
        ...
        switch (String.valueOf(cpsCertificateNO.getIssueCPSNo()).length()) {
            case 1:
                lblCPSNo.setText(cpString + "IC-000" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 2:
                lblCPSNo.setText(cpString + "IC-00" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 3:
                lblCPSNo.setText(cpString + "IC-0" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 4:
                lblCPSNo.setText(cpString + "IC-" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            default:
                break;
        }
    ...
    private javax.swing.JTextField txtSalaryInRupees;
