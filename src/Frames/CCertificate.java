...
public class CCertificate extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Character Certificate");
        setOpaque(false);
        try {
            setSelected(true);
        ...
        lblPageNo.setBounds(6, 0, 160, 17);

        lblCPSNo.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblCPSNo.setText("CPS NO:CC-0001");
        getContentPane().add(lblCPSNo);
        lblCPSNo.setBounds(554, 0, 120, 17);
        ...
        jPanel1.setBounds(6, 23, 667, 280);
        ...
        jPanel2.setBounds(6, 316, 667, 108);
        ...
        btnSave.setBounds(197, 437, 55, 29);
        ...
        btnClear.setBounds(433, 437, 58, 29);
    ...
    private void getcpCertificateNo() {
        CCBal certificateBal = new CCBal();
        ...
        switch (String.valueOf(cpsCertificateNO.getIssueCPSNo()).length()) {
            case 1:
                lblCPSNo.setText(cpString + "CC-000" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 2:
                lblCPSNo.setText(cpString + "CC-00" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 3:
                lblCPSNo.setText(cpString + "CC-0" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 4:
                lblCPSNo.setText(cpString + "CC-" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            default:
                break;
        }
