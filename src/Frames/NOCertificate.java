...
public class NOCertificate extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("No Objection Certificate");
        ...
        lblCPSNo.setText("CPS NO:NO-0001");
        getContentPane().add(lblCPSNo);
        lblCPSNo.setBounds(533, 0, 140, 17);
        ...
        DateChooser.setDateFormatString("yyyy/MM/dd"); // NOI18N
        ...
        jPanel1.setBounds(10, 20, 666, 280);
        ...
        jPanel2.setBounds(10, 310, 663, 105);
        ...
        btnSave.setBounds(10, 500, 54, 27);
        ...
        btnClear.setBounds(610, 500, 58, 27);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "No Objection Certificate Information", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14))); // NOI18N
        jPanel3.setOpaque(false);

        jLabel21.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel21.setText("NOC For:");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtNocFor, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3.setBounds(10, 420, 666, 77);
        ...
        jLabel1.setBounds(-10, 0, 690, 550);
    ...
    private void  getcpCertificateNo(){
        NOCBal certificateBal = new NOCBal();
        ...
        switch (String.valueOf(cpsCertificateNO.getIssueCPSNo()).length()) {
            case 1:
                lblCPSNo.setText(cpString + "NO-000" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 2:
                lblCPSNo.setText(cpString + "NO-00" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 3:
                lblCPSNo.setText(cpString + "NO-0" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 4:
                lblCPSNo.setText(cpString + "NO-" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            default:
                break;
        }
    ...
    private void txtCNICKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCNICKeyReleased
        ...
        if (cnic.length() == 15) {
            ...
            CDetailBean search = new NOCBal().search(cnic);
            if (search != null) {
