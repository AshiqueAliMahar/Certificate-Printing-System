...
public class NMCertificate extends javax.swing.JInternalFrame {

    public NMCertificate() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("No Marriage Certificate");
        ...
        lblPageNo.setBounds(6, 0, 124, 17);

        lblCPSNo.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblCPSNo.setText("CPS NO:NM-0001");
        getContentPane().add(lblCPSNo);
        lblCPSNo.setBounds(562, 0, 116, 17);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtApplicantName, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)
        ...
        jPanel1.setBounds(6, 23, 672, 281);
        ...
        btnSave.setBounds(190, 422, 55, 29);
        ...
        btnClear.setBounds(435, 422, 57, 29);
    ...
    private void txtCNICKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCNICKeyReleased
        ...
        if (cnic.length() == 15) {
            ...
            CDetailBean search = new NMCBal().search(cnic);
            if (search != null) {
    ...
    private void getcpCertificateNo() {
        NMCBal certificateBal = new NMCBal();
        ...
        switch (String.valueOf(cpsCertificateNO.getIssueCPSNo()).length()) {
            case 1:
                lblCPSNo.setText(cpString + "NM-000" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 2:
                lblCPSNo.setText(cpString + "NM-00" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 3:
                lblCPSNo.setText(cpString + "NM-0" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            case 4:
                lblCPSNo.setText(cpString + "NM-" + (cpsCertificateNO.getIssueCPSNo()));
                break;
            default:
                break;
        }
